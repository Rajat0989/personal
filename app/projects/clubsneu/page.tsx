          ...
          <StaggerWrapper {...getTransition(0)}>
            <section className="flex flex-col gap-[1.5rem]">
              <div className="flex flex-col gap-[0.75rem]">
                ...
                <p className="b_serif">
                  From March to December 2023, as the founding designer, I
                  worked with an engineer to ship a new platform that helps
                  Northeastern students discover and connect with clubs. Check
                  out the{" "}
                  <a
            ...
            <section className="flex flex-col gap-5">
              <div className="flex flex-col gap-1">
                ...
                <p className="b_serif">
                  ...
                  one<SerifChar>:</SerifChar> not joining enough clubs. Having
                  faced a similar issue, I decided to explore it further.
                </p>
              </div>
              ...
              <div className="flex flex-col gap-2">
                <div className="flex flex-col gap-1">
                  <h3>
                    Why was participation low<SerifChar>?</SerifChar>
                  </h3>
                  <p className="b_serif">
                    Talking to 10<SerifChar>+</SerifChar> students and reviewing
                    existing platforms gave us valuable insights. Students
                    mentioned three products, each with distinct pain points.
                  </p>
                </div>
                <div className="w-full inner-shadow-tertiary rounded-[0.375rem]">
                  <Image
            ...
            <section className="flex flex-col gap-5">
              <div className="flex flex-col gap-2">
                <div className="flex flex-col gap-1">
                  ...
                  <p className="b_serif">
                    The toolbar is the primary interaction point for filtering
                    and sorting the database. There were two options
                    <SerifChar>:</SerifChar> horizontal and vertical, each with
                    their pros and cons.
                  </p>
                </div>
                <div className="w-full inner-shadow-tertiary rounded-[0.375rem]">
