          ...
          <StaggerWrapper {...getTransition(0)}>
            <section className="flex flex-col gap-[1.5rem]">
              <div className="flex flex-col gap-[0.75rem]">
                <h2>
                  Building a AI personal clothing shopper that learns your style
                </h2>
                <p className="b_serif">
                  As the sole designer at Fetchr, a pre-seed YC-backed startup,
                  I am leading the design of an AI stylist that builds trust and
